...
These diagrams describe the repository's component boundaries and the data flow
for a benchmark run. The platform is simulation-only: results are evidence for
