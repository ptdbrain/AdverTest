...
def detection_metric_suite(
    ...
    summary = detection_summary(predictions, samples, 0.5)
    if summary.ground_truths:
        detection_rate = summary.true_positives / summary.ground_truths
        miss_rate = summary.false_negatives / summary.ground_truths
    else:
        detection_rate = 0.0
        miss_rate = 0.0
    return {
        ...
        # Detection Rate = share of ground-truth boxes matched; Miss Rate is
        # its complement (workflow §8: Object Detection metric set).
