...
class CompositionContext:
    ...
    retain_intermediate_arrays: bool = True
        ...
        for index, step in enumerate(recipe.steps):
            ...
            try:
                ...
                if not selected:
                    ...
                    _append_intermediate(current.image, arrays, hashes, retain_array=context.retain_intermediate_arrays)
                    continue
