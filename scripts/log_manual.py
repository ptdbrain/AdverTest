...
if sys.platform == "win32":
    # PowerShell may launch Python with cp1252 even though prompts/logs are UTF-8.
    # Reconfigure console output so a successful write is not reported as a failure.
