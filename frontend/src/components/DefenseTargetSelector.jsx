  ...
  return (
    ...
    >
      ...
      <div className="space-y-4 p-4">
        {error && (
          <div role="alert" className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-red-200 bg-red-50 px-3 py-2.5 text-xs text-red-800">
        ...
        {!selectedRun ? (
          ...
          <dl className="grid grid-cols-1 gap-x-5 gap-y-3 rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <ProvenanceItem label="Mức tấn công" value={selectedRun.severity == null ? missingValue : `Cấp ${selectedRun.severity}`} />
