    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <div className="space-y-0.5">
          ...
          <p className="text-[24px] font-bold text-[#0F172A] leading-tight tracking-tight">{value}</p>
        </div>
        {Icon && (
          <div
            className={cn(
      ...
      <div className="flex items-end justify-between pt-1 border-t border-slate-50">
        {trend && (
          <div className="text-[11px] font-medium text-slate-500 leading-tight">
            <span className={cn("font-semibold mr-1", isPositive ? "text-emerald-600" : "text-red-600")}>{trend}</span>
