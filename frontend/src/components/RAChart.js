        ...
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} margin={{ top: 24, right: 24, bottom: 24, left: 0 }} barCategoryGap="20%">
            ...
            <YAxis
              ...
              axisLine={{ stroke: "var(--border-subtle)" }}
            />
            <Tooltip content={<CustomBarTooltip />} cursor={{ fill: "var(--bg-hover)", opacity: 0.4 }} />
            <ReferenceLine
              y={100}
              stroke="var(--success)"
              strokeDasharray="3 3"
              opacity={0.5}
              label={{ value: "100% Clean", position: "insideTopRight", fill: "var(--success)", fontSize: 10 }}
            />
            <ReferenceLine
              y={50}
              stroke="var(--warning)"
              strokeDasharray="3 3"
              opacity={0.5}
              label={{ value: "50% Boundary", position: "insideTopRight", fill: "var(--warning)", fontSize: 10 }}
            />
