export default function SamWaitingState() {
  ...
  return (
    <section
      className="sam-waiting"
      aria-label="SAM2 handoff status"
      style={{
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px" }}>
        <span
          className="status-badge status-badge--queued"
          style={{ background: "var(--warning)", color: "#000", fontWeight: "bold" }}
        >
          WAITING_FOR_ARTIFACTS
        </span>
        <p className="evidence-stage__eyebrow" style={{ margin: 0, color: "var(--warning)" }}>
          Segmentation Mode Handoff Gate
        </p>
      </div>
      ...
      <div
        className="missing-artifacts-list"
        style={{
