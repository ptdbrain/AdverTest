...
import ConfigureAttackPage, { normalizeAttackQueue } from "../page";
...
describe("ConfigureAttackPage real run handoff", () => {
  ...
  it("persists backend report and samples before opening visual results", async () => {
    ...
    const sample = {
      ...
      artifacts: { clean_input_url: "/data/runs/run-real-001/clean.png", attacked_input_url: "/data/runs/run-real-001/attacked.png" },
