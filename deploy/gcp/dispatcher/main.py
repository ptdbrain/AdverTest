...
def dispatch(body: DispatchRequest, authorization: str | None = Header(default=None)) -> dict[str, str]:
    ...
    # The GPU service has min instances = 0. Pub/Sub starts it on demand and
    # retains this delivery through the cold start.
    return {"job_id": body.job_id, "message_id": message_id, "gpu_state": "STARTING"}
